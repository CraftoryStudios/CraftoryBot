...
const generatorEmbed = {
	description:
		'The Solid Fuel Generator burns fuel like a furnace to generate energy, this can be used to power machines, stored in cells, or distributed across a Power Grid. Learn more here.\n\n https://craftory.studio/craftory-tech/wiki/solid-fuel-generator.html',
	color: 4510943,
	author: {
		name: 'Solid Fuel Generator',
		icon_url:
...
const solarEmbed = {
	description:
		'Solar Panels produce energy from sunlight. To work they need the sun to be up and have direct line of sight to the sky. Learn more here.\n\n https://craftory.studio/craftory-tech/wiki/solar-panel.htmls',
	color: 1466470,
	author: {
		name: 'Solar Panel',
		icon_url:
...
const magnatiserEmbed = {
	description:
		'One of the core crafting components is Magnetised Iron, a magnatiser can be used to produce it. Learn more here.\n\n https://craftory.studio/craftory-tech/wiki/magnatiser.html',
	color: 14787310,
	author: {
		name: 'Magnatiser',
		icon_url:
...
const magTableEmbed = {
	description:
		'The Magnetising Table is a manual version that requires no Energy. A Engineers Hammer is used to hit it and progress the crafting. Learn more here.\n\n https://craftory.studio/craftory-tech/wiki/magnatisation-table.html',
	color: 5004670,
	author: {
		name: 'Magnatisation Table',
		icon_url:
...
const maceratorEmbed = {
	description:
		'Macerators are used to double ores and create dust! Learn more here.\n\n https://craftory.studio/craftory-tech/wiki/macerator.html',
	color: 13278699,
	author: {
		name: 'Macerator',
		icon_url:
...
const foundryEmbed = {
	description:
		'Foundries are used to combine two materials together. Currently their only use is the production of steel from Iron Ingots and Charcoal or Coal Dust. Learn more here.\n\n https://craftory.studio/craftory-tech/wiki/foundry.html',
	color: 4845196,
	author: {
		name: 'Foundry',
		icon_url:
...
const placerEmbed = {
	description:
		'Block Placers are capable of placing blocks in their inventory in front of them. To do this they require energy, a place able block in their inventory and AIR in front of them. Learn more here.\n\n https://craftory.studio/craftory-tech/wiki/block-placer.html',
	color: 6703525,
	author: {
		name: 'Block Placer',
		icon_url:
...
const furnaceEmbed = {
	description:
		'Electric Furnaces perform all functions of a normal Minecraft furnace, but require power rather than fuel. Learn more here.\n\n https://craftory.studio/craftory-tech/wiki/electric-furnace.html',
	color: 6703525,
	author: {
		name: 'Electric Furnace',
		icon_url:
