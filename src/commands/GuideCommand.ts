...
const resourcePackEmbed = {
	description:
		'If you are going to use Craftory with another resource pack on your server. You will need to merge the two resource packs. If your server is using the Transport Pipes in addition to Craftory you will need to choose the needed resource pack. \n\nCraftory with Pipes:\nhttps://github.com/CraftoryStudios/Craftory-Tech/tree/master/resourcepacks/pipes \n\nCraftory Standalone: \nhttps://github.com/CraftoryStudios/Craftory-Tech/tree/master/resourcepacks/original',
	color: 3077393,
	author: {
