...
const resourcePackEmbed = {
    "description": "If you are going to use Craftory Tech with another resource pack on your server. You will need to merge the two resource packs. Download the Craftory resource pack and learn more here.\n\nhttps://github.com/CraftoryStudios/Craftory-TechResources",
    "color": 3077393,
    "author": {
  ...
  const resourcePackFAQEmbed = {
    "description": "Having trouble getting the Craftory Tech resource pack working, follow these troubleshooting steps! \n\nhttps://craftory.studio/craftory-tech/wiki/resource-pack-problems.html",
    "color": 3077393,
    "author": {
